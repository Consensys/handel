...
type Adaptor interface {
	Make(ctx context.Context, nodes lib.NodeList, ids []int, opts Opts) (handel.Registry, []Node)
}

// AdaptorFunc returns an Adaptor out of a func
type AdaptorFunc func(ctx context.Context, nodes lib.NodeList, ids []int, opts Opts) (handel.Registry, []Node)

// Make implements the Adaptor interface
func (a AdaptorFunc) Make(ctx context.Context, nodes lib.NodeList, ids []int, opts Opts) (handel.Registry, []Node) {
...
func WithConnector(a AdaptorFunc) AdaptorFunc {
	return func(ctx context.Context, lnodes lib.NodeList, ids []int, opts Opts) (handel.Registry, []Node) {
		reg, nodes := a(ctx, lnodes, ids, opts)
