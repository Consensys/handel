...
func (c MasterCommands) Start(masterAddr string, nbOfNodes, timeOut int) string {
	return "nohup " + c.MasterBinPath + " -masterAddr " + masterAddr + " -nbOfNodes " + strconv.Itoa(nbOfNodes) + " -timeOut " + strconv.Itoa(timeOut) + " > " + logFile
}
